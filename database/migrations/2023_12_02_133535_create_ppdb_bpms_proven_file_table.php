...
class CreatePpdbBpmsProvenFileTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('ppdb_bpms_proven_files', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('ppdb_bpms_proven_file');
    }
}
